...
PM_START_TEXT = "✨ *ɪ ᴀᴍ ᴛ sᴇʀɪᴇs, ᴀ ɢᴇɴꜱʜɪɴ ɪᴍᴘᴀᴄᴛ ᴛʜᴇᴍᴇᴅ ʀᴏʙᴏᴛ ᴡʜɪᴄʜ ᴄᴀɴ ʜᴇʟᴘ ʏᴏᴜ ᴛᴏ ᴍᴀɴᴀɢᴇ ᴀɴᴅ ꜱᴇᴄᴜʀᴇ ʏᴏᴜʀ ɢʀᴏᴜᴘ ᴡɪᴛʜ ʜᴜɢᴇ ɢʀᴏᴜᴘ ᴍᴀɴᴀɢᴇᴍᴇɴᴛ*"
...
ALIVE_BTN = [
    [
        ib(text="UPDATES", url="https://t.me/HEROKU_CC_STORE"),
        ib(text="SUPPORT", url="https://t.me/DOSTO_KI_M3HFIL"),
    ],
    [
        ib(
            text="⇦ ADD ME ⇨",
