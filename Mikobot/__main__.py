        ...
        await query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    ...
                    [
                        InlineKeyboardButton("» 𝙃𝙊𝙈𝙀 «", callback_data="T-series_back"),
                    ],
                ],
            ),
        )
...
async def gitsource_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if query.data == "git_source":
        source_link = "https://t.me/DOSTO_KI_M3HFIL"
        message_text = (
            f"*Here is the link for the public source repo*:\n\n{source_link}"
        )

        # Adding the inline button
        keyboard = [[InlineKeyboardButton(text="◁", callback_data="T-series_back")]]
        ...
        await query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            text="ABOUT", callback_data="HEROKU_CC_STORE"
                        ),
                    ...
                    [
                        InlineKeyboardButton(text="◁", callback_data="T-series_back"),
                    ],
                ]
            ),
        )
    elif query.data == "HEROKU_CC_STORE":
        message_text = (
        ...
        await query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    ...
                    [
                        InlineKeyboardButton(text="◁", callback_data="Tseries_"),
                    ],
                ]
            ),
        )
    elif query.data == "T-series_back":
        first_name = update.effective_user.first_name
        await query.message.edit_text(
...
def main():
    ...
    function(CallbackQueryHandler(Miko_about_callback, pattern=r"Tseries_"))
    ...
    LOGGER.info("T-SERIES BOT is starting >> Using long polling.")
